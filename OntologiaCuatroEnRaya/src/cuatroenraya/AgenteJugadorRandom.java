 ...
 */
public class AgenteJugadorRandom extends Agent {
    ...
    class MovimientoJ extends AchieveREResponder {
        ...
        protected ACLMessage prepareResultNotification(ACLMessage request, ACLMessage response) throws FailureException {
            ...
            /*
             * A partir de aquí empieza la AI para colocar la ficha en el tablero.
             */

            ///Inicio de inteligencia aleatoria
            ...
            ///Buscamos todas las posiciones disponibles
            int index, pos;
            index = pos = 0;
            for (int i = 0; i < tableroActual.getNumFilas(); ++i) {
                for (int j = 0; j < tableroActual.getNumColumnas(); ++j) {
            ...
            ///De entre todas las posiciones libres, eleguimos una.
            Random generator = new Random();
            if (index != 0) {
                pos = generator.nextInt(index);
                tablero[Vi[pos]][Vj[pos]] = fichaActual.getColor();
            }

            /*
             * Aquí acaba el algoritmo AI
             */

            ///Creamos el cuerpo de la acción
            Jugador jugador = new Jugador(this.myAgent.getAID(), fichaActual);
            Posicion posicion = new Posicion(Vi[pos], Vj[pos]);
            ...
            if (index != 0) {
                ...
                System.out.println("El tablero nos ha enviado un tablero lleno, sufrió una descompostura!");
                System.out.println("Lanzamos una excepción.");
                jugando = false;
                throw new FailureException("Tablero lleno");
            }
        }
    }
